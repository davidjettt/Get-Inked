...
export default function SingleTattooModal({ tattooId, fromTattoos, studioPortfolio, small, medium }) {
    ...
    return (
        <>
            ...
            {showModal && <Modal onClose={() => setShowModal(false)}>
                <SingleTattoo fromTattoos={fromTattoos} studioPortfolio={studioPortfolio} tattooId={tattooId} />
            </Modal>}
        </>
    )
}
