...
# Login manager to keep track of current user
@login.user_loader
def load_user(id):
...
# Well.........
# Edits all 'http' requests to 'https' in production
@app.before_request
def https_redirect():
...
# injects csrf token after every request
@app.after_request
...
# Directs request to get favicon and index.html
